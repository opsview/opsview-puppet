...
Puppet::Type.type(:opsview_hostcheckcommand).provide :opsview, :parent => Puppet::Provider::Opsview do
  @object_type='hostcheckcommand'
  ...
  def default_object
   json = '
   {
         "name" : "Puppet-created host check command"
   }'
