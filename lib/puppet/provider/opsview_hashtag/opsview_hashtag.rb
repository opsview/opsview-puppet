...
Puppet::Type.type(:opsview_hashtag).provide :opsview, :parent => Puppet::Provider::Opsview do
  @object_type='keyword'
  ...
  def self.generic_fields
    [:all_hosts, :all_servicechecks, :exclude_handled, :public, :show_contextual_menus, :visible]
  end
